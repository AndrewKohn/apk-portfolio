...
const AvatarClosed = ({ className }: Props) => {
  return (
    <svg
      width="264px"
      height="280px"
          ...
          <g transform="translate(825.000000, 1100.000000)">
            ...
            >
              ...
              <g id="Top" strokeWidth="1" fillRule="evenodd">
                ...
                <mask id="react-mask-661" fill="white">
                  <use xlinkHref="#react-path-663"></use>
                </mask>
                <g id="Mask"></g>
                <g id="Top/Short-Hair/Short-Flat" mask="url(#react-mask-661)">
                  <g transform="translate(-1.000000, 0.000000)">
                    <mask id="react-mask-660" fill="white">
                      <use xlinkHref="#react-path-662"></use>
                    </mask>
                    <use
                      id="Short-Hair"
                      stroke="none"
                      fill="#1F3140"
                      fillRule="evenodd"
                      xlinkHref="#react-path-662"
                    ></use>
                    <g
                      id="Skin/👶🏽-03-Brown"
                      mask="url(#react-mask-660)"
                      fill="#2C1B18"
                    >
                      <g transform="translate(0.000000, 0.000000) " id="Color">
                        <rect x="0" y="0" width="264" height="280"></rect>
